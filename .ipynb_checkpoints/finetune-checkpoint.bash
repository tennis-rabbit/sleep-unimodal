...
# CUDA_VISIBLE_DEVICES=0,1,2,3 /u/ztshuai/.conda/envs/melp/bin/python main_pretrain.py --num_workers 8 --num_devices 4 --num_nodes 1\
#     --lr 2e-4 --model_name "clip" --batch_size 40 --max_epochs 100 \
#     --clip_loss_weight 1.0 --caption_loss_weight 2.0 --local_loss_weight 0.2
CUDA_VISIBLE_DEVICES=0 /u/ztshuai/.conda/envs/melp/bin/python main_finetune.py \
    --train_data_pct 0.01 \
    --ckpt_path '/scratch/besp/shared_data/test_zitao_pretrain/logs/melp/ckpts/sleep_unimodal_clip_2025_08_18_17_35_06/last.ckpt'\
    --num_devices 1\
    --train_data_pct 0.1\